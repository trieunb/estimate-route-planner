 angular.module('Erp')
    .controller('AddReferralRouteCtrl', ['$scope', '$rootScope', 'referralFactory',
        'referralRouteFactory', '$location', '$filter', 'uiGmapGoogleMapApi', 'uiGmapIsReady', AddReferralRouteCtrl]);
...
function AddReferralRouteCtrl(
    ...
    $rootScope.pageTitle = 'Referral route planner';
