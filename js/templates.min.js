angular.module('Erp').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('templates/crew-route/add.html',
    ...
    "\n" +
    "                    <li ui-tree-node class=\"box-assign\" ng-repeat=\"estimate in assignedEstimates\" ng-class=\"{'highlight': estimate.highlight}\">\r" +
    "\n" +
    ...
    "\n" +
    "                    <li ui-tree-node class=\"box-assign\" ng-repeat=\"estimate in pendingEstimates\" ng-class=\"{'highlight': estimate.highlight}\">\r" +
    "\n" +
    "                        <div class=\"queue-item-info\">\r" +
    "\n" +
    "                            <a href=\"#/edit-estimate/{{::estimate.id}}\" target=\"_blank\" ng-if=\"::hasCap('erpp_edit_estimates')\">{{::estimate.job_customer_display_name}}</a>\r" +
    ...
    "                        idkey=\"$index\"\r" +
    "\n" +
    "                        coords=\"estimate.coords\"\r" +
    "\n" +
    "                        events=\"estimate.markerEvents\">\r" +
    "\n" +
    "                        <ui-gmap-window show=\"estimate.show_infor_window\" closeClick=\"estimate.show_infor_window = false; estimate.highlight = false\">\r" +
    "\n" +
    "                            <p>\r" +
    "\n" +
  ...
  $templateCache.put('templates/customer/modal.html',
    ...
    "                        </div>\n" +
    "                        <div class=\"col-md-6 col-sm-12\">\n" +
    "                            <label for=\"last_name\" class=\"required\">Last name<span>(*)</span></label>\n" +
    "                            <input type=\"text\"\n" +
    "                                class=\"form-control\"\n" +
    "                                ng-required=\"true\"\n" +
    "                                name=\"last_name\"\n" +
