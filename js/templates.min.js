angular.module('Erp').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('templates/company-info.html',
    ...
    "                        <div class=\"row space_nomal\">\n" +
    "                            <div class=\"form-group\">\n" +
    "                                <label class=\"control-label col-sm-3\">Estimate Email Template</label>\n" +
    "                                <div class=\"col-sm-9\">\n" +
    "                                    <textarea class=\"form-control textarea_size\"\n" +
    "                                    type=\"text\"\n" +
    "                                    name=\"setting.email_template\"\n" +
    "                                    rows=\"10\"\n" +
    "                                    ng-model=\"info.email_template\">\n" +
    "                                    </textarea>\n" +
    "                                    <p class=\"text-muted\">\n" +
    "                                    Embeddable variables: <span class=\"text-info\">estimate_number, estimate_total, billing_customer_first_name, billing_customer_last_name</span>\n" +
    "                                    <br>\n" +
    "                                    Usage: <span ng-non-bindable class=\"text-info\">Dear {{billing_customer_first_name}}</span>\n" +
    "                                    </p>\n" +
    "                                </div>\n" +
    "                            </div>\n" +
    "                        </div>\n" +
  ...
  $templateCache.put('templates/estimate/edit.html',
    ...
    "                    <tbody as-sortable=\"lineItemsDragListeners\" data-ng-model=\"estimate.lines\" is-disabled=\"estimate.lines.length == 1\">\n" +
    "                      <tr ng-repeat=\"line in estimate.lines\" as-sortable-item>\n" +
    "                        <td ng-if=\"::hasCap('erpp_view_estimate_total')\" class=\"drag-shell\" data-as-sortable-item-handle><span class=\"glyphicon glyphicon-th\"></span></td>\n" +
    "                        <td><span ng-bind=\"$index + 1\"></span></td>\n" +
    "                        <td>\n" +
    "                            <selectize\n" +
    "                                ng-model=\"line.product_service_id\"\n" +
    ...
    "                                ng-readonly=\"::!hasCap('erpp_view_estimate_total')\"\n" +
    "                                ng-model=\"line.description\"\n" +
    "                                ng-model-options=\"{ updateOn: 'blur' }\"\n" +
    "                                /></textarea>\n" +
    "                        </td>\n" +
    ...
    "                    ng-click=\"showSendModal = false\"><span aria-hidden=\"true\">×</span>\n" +
    "                  </button>\n" +
    "                </div>\n" +
    ...
    "                      </button>\n" +
    "                      <button class=\"btn btn-default\" type=\"button\" ng-click=\"showSendModal = false\">Cancel</button>\n" +
    "                    </div>\n" +
    "                </form>\n" +
    "            </div>\n" +
    "        </div>\n" +
