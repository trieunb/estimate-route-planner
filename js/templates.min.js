angular.module('Erp').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('templates/crew-route/add.html',
    ...
    "                                ng-required=\"true\"\r" +
    "\n" +
    "                                ng-options=\"status.value as status.label for status in ::routeStatuses\">\r" +
    "\n" +
    "                            </select>\r" +
    "\n" +
    "                        </div>\r" +
  ...
  $templateCache.put('templates/crew-route/list.html',
    ...
    "\n" +
    "              ng-init=\"route.new_status = route.status\" ng-model=\"route.new_status\" ng-options=\"status.value as status.label for status in ::routeStatuses\"\r" +
    "\n" +
  ...
  $templateCache.put('templates/crew-route/work-order.html',
    ...
    "                        <li ng-repeat=\"line in est.lines\" ng-class=\"{'line-empty': !line.product_service_id}\">\n" +
    "                            <span ng-if=\"line.product_service_id\">\n" +
  ...
  $templateCache.put('templates/estimate/add.html',
    ...
    "                            ng-required=\"true\"\n" +
    "                            ng-init=\"estimate.status = estimateStatuses[0].value\"\n" +
    "                            >\n" +
    "                        </select>\n" +
    "                    </div>\n" +
    "                </div>\n" +
