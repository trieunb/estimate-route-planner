angular.module('Erp').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('templates/company-info.html',
    ...
    "                                    </textarea>\n" +
    "                                    <p class=\"text-muted\">\n" +
    "                                    Embeddable variables: <span class=\"text-info\">estimate_number, estimate_total, billing_customer_display_name, shipping_customer_display_name</span>\n" +
    "                                    <br>\n" +
    "                                    Usage: <span ng-non-bindable class=\"text-info\">Dear {{billing_customer_display_name}}</span>\n" +
    "                                    </p>\n" +
    "                                </div>\n" +
    "                            </div>\n" +
    "                        </div>\n" +
