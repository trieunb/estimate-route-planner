angular.module('Erp').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('templates/company-info.html',
    ...
    "                                <div class=\"col-sm-9\">\n" +
    "                                    <textarea rows=\"3\" class=\"form-control\" type=\"text\" name=\"mailing_address\" ng-model=\"info.mailing_address\" required></textarea>\n" +
  ...
  $templateCache.put('templates/crew-route/add.html',
    ...
    "\n" +
    "                    ng-model=\"$parent.assigned_queue_sort_by\"\r" +
    "\n" +
    ...
    "                </select>\r" +
    "\n" +
    "                <ul ui-tree-nodes ng-model=\"assignedEstimates\">\r" +
    "\n" +
    "                    <li ui-tree-node class=\"box-assign\" ng-repeat=\"estimate in assignedEstimates\">\r" +
    "\n" +
    ...
    "                        <br>\r" +
    "\n" +
    "                        {{:: estimate | estimateJobFullAddress }}\r" +
    "\n" +
    "                        <br>\r" +
    "\n" +
    ...
    "\r" +
    "\n" +
    "            <h4 class=\"h4-title\">Accepted Estimates</h4>\r" +
    "\n" +
    "\r" +
    "\n" +
    ...
    "                </select>\r" +
    "\n" +
    "                <ul ui-tree-nodes ng-model=\"pendingEstimates\">\r" +
    "\n" +
    "                    <li ui-tree-node class=\"box-assign\" ng-repeat=\"estimate in pendingEstimates\">\r" +
    "\n" +
    "                        <span ui-tree-handle class=\"drag-handler glyphicon glyphicon-th-large\"></span>\r" +
    "\n" +
    "                        <a href=\"#/edit-estimate/{{::estimate.id}}\" target=\"_blank\" ng-if=\"::hasCap('erpp_edit_estimates')\">{{::estimate.job_customer_display_name}}</a>\r" +
    ...
    "            <div class=\"row\">\r" +
    "\n" +
    "                <form name=\"routeForm\" ng-submit=\"saveRoute()\" class=\"form-route\">\r" +
    "\n" +
    "                    <div class=\"col-md-8\">\r" +
    "\n" +
    "                        <label for=\"title\" class=\"required col-sm-2 n-p\">Title: </label>\r" +
    "\n" +
    "                        <div class=\"col-sm-10 n-p\">\r" +
    "\n" +
    "                            <input type=\"text\" class=\"form-control\" name=\"title\" ng-model=\"route.title\" ng-required=\"true\"/>\r" +
    "\n" +
    "                        </div>\r" +
    "\n" +
    "                    </div>\r" +
    ...
    "\n" +
    "                            <button class=\"btn btn-sm btn-default\" type=\"button\" ng-click=\"printRoute()\" ng-if=\"::hasCap('erpp_print_estimate_routes')\">Print</button>\r" +
    "\n" +
    "                            <button class=\"btn btn-sm btn-primary\" type=\"submit\"\r" +
    "\n" +
  ...
  $templateCache.put('templates/crew-route/edit.html',
    ...
    "                            </div>\r" +
    "\n" +
    "                            <div class=\"col-md-4 col-xs-5\">\r" +
    "\n" +
    "                                <label for=\"status\" class=\"col-sm-4 n-p\">Status: </label>\r" +
    "\n" +
    ...
    "                        <div class=\"btn-action text-right\">\r" +
    "\n" +
    "                            <button ng-click=\"printRoute()\" class=\"btn btn-sm btn-default\" type=\"button\" ng-if=\"::hasCap('erpp_print_estimate_routes')\">Print</button>\r" +
    "\n" +
    "                            <button class=\"btn btn-sm btn-primary\" type=\"submit\" ng-disabled=\"routeForm.$invalid\">Update</button>\r" +
    "\n" +
    "                        </div>\r" +
    "\n" +
    "                    </div>\r" +
  ...
  $templateCache.put('templates/estimate-route/add.html',
    ...
    "                </select>\r" +
    "\n" +
    "                <ul ui-tree-nodes ng-model=\"assignedReferrals\">\r" +
    "\n" +
    "                    <li ui-tree-node class=\"box-assign\" ng-repeat=\"referral in assignedReferrals\">\r" +
    "\n" +
    "                        <span ui-tree-handle class=\"drag-handler glyphicon glyphicon-th-large\"></span>\r" +
    "\n" +
    ...
    "\n" +
    "                        <span>Date: {{::referral.date_requested}}</span><br>\r" +
    "\n" +
    ...
    "                </select>\r" +
    "\n" +
    "                <ul ui-tree-nodes=\"\" ng-model=\"pendingReferrals\">\r" +
    "\n" +
    "                    <li class=\"box-assign\" ng-repeat=\"referral in pendingReferrals\" ui-tree-node>\r" +
    "\n" +
    "                        <span ui-tree-handle class=\"drag-handler glyphicon glyphicon-th-large\"></span>\r" +
    "\n" +
    "                        <a href=\"#/edit-job-request/{{::referral.id}}\" target=\"_blank\" ng-if=\"::hasCap('erpp_edit_job_requests')\">{{::referral.customer_display_name}}</a>\r" +
    ...
    "\n" +
    "                                Date: {{::referral.date_requested}}<br/>\r" +
    "\n" +
    "                                Estimator: {{::referral.estimator_full_name}}<br>\r" +
    "\n" +
  ...
  $templateCache.put('templates/estimate-route/edit.html',
    ...
    "                <ul ui-tree-nodes ng-model=\"assignedReferrals\">\r" +
    "\n" +
    "                    <li class=\"box-assign\" ng-repeat=\"referral in assignedReferrals\" ui-tree-node>\r" +
    "\n" +
    "                        <span ui-tree-handle class=\"drag-handler glyphicon glyphicon-th-large\"></span>\r" +
    "\n" +
    "                        <a href=\"#/edit-job-request/{{::referral.id}}\" target=\"_blank\" ng-if=\"::hasCap('erpp_edit_job_requests')\">{{::referral.customer_display_name}}</a>\r" +
    ...
    "\r" +
    "\n" +
    "            <h4 class=\"h4-title\">Current Assigned Requests</h4>\r" +
    "\n" +
    "            <table class=\"table table-bordered table-fixed header-fixed\">\r" +
    "\n" +
    "                <thead>\r" +
    ...
    "                        <th>Customer</th>\r" +
    "\n" +
    "                        <th>Date Requested</th>\r" +
    "\n" +
    "                        <th>Estimator</th>\r" +
    "\n" +
    "                        <th>Status</th>\r" +
    "\n" +
    "                        <th ng-if=\"::hasCap('erpp_edit_job_requests')\">Action</th>\r" +
    "\n" +
    "                    </tr>\r" +
    "\n" +
    "                </thead>\r" +
    ...
    "                <tbody>\r" +
    "\n" +
    "                    <tr ng-repeat=\"referral in currentAssignedReferrals\">\r" +
    "\n" +
    "                        <td><span>{{:: referral.customer_display_name}}</span></td>\r" +
    "\n" +
    "                        <td><span>{{:: referral.date_requested}}</span></td>\r" +
    "\n" +
    "                        <td><span>{{:: referral.estimator_full_name}}</span></td>\r" +
    "\n" +
    "                        <td><span>{{:: referral.status}}</span></td>\r" +
    "\n" +
    "                        <td ng-if=\"::hasCap('erpp_edit_job_requests')\">\r" +
    "\n" +
    "                            <a href=\"#/edit-job-request/{{:: referral.id}}\">Edit</a>\r" +
    "\n" +
    "                        </td>\r" +
    "\n" +
    "                    </tr>\r" +
    "\n" +
    "                    <tr ng-if=\"!$root.isBusy && currentAssignedReferrals.length == 0\">\r" +
    "\n" +
    "                        <td colspan=\"4\" class=\"text-center\">\r" +
    "\n" +
    "                            No requests assigned yet\r" +
    "\n" +
    "                        </td>\r" +
    "\n" +
    "                    </tr>\r" +
  ...
  $templateCache.put('templates/estimate/add.html',
    ...
    "                            </div>\n" +
    "                        <div class=\"col-sm-12\">\n" +
    "                            <div class=\"div-customer-signature-preview text-center\">\n" +
  ...
  $templateCache.put('templates/estimate/edit.html',
    ...
    "                <div class=\"col-sm-6 col-sm-offset-1\">\n" +
    "                    <div class=\"form-group\">\n" +
    "                        <label class=\"col-sm-11 col-sm-offset-1 col-xs-10 col-xs-offset-2\" for=\"estimate_footer\">\n" +
    "                            Estimate Footer</label>\n" +
  ...
  $templateCache.put('templates/job-request/add.html',
    ...
    "                </div>\n" +
    "                <div class=\"form-group\">\n" +
    "                    <label class=\"control-label col-sm-4\" for=\"status\">Estimator Assigned\n" +
    "                    </label>\n" +
    "                    <div class=\"col-sm-8\">\n" +
    "                        <selectize\n" +
    "                            config=\"employeesSelectConfig\"\n" +
    "                            ng-model=\"referral.estimator_id\"\n" +
    "                            options=\"employees\">\n" +
    "                        </selectize>\n" +
    "                    </div>\n" +
    "                </div>\n" +
