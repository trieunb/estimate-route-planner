angular.module('Erp').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('templates/crew-route/add.html',
    ...
    "\n" +
    "                        <label for=\"status\" class=\"col-sm-2 n-p\">Status: </label>\r" +
    "\n" +
    ...
    "                    </div>\r" +
    "\n" +
    "                    <div class=\"col-md-3 col-sm-12\">\r" +
    "\n" +
    "                        <div class=\"btn-action text-right\">\r" +
    "\n" +
    "                            <button class=\"btn btn-default\" type=\"button\" ng-click=\"printRoute()\" ng-if=\"::hasCap('erpp_print_crew_routes')\">Print</button>\r" +
    "\n" +
    ...
    "\n" +
    "            <h5 class=\"route-box-title\">Assigned Routes</h5>\r" +
    "\n" +
    ...
    "\r" +
    "\n" +
    "            <h5 class=\"route-box-title\">Accepted Estimates</h5>\r" +
    "\n" +
    "\r" +
    "\n" +
  ...
  $templateCache.put('templates/estimate-route/add.html',
    ...
    "\n" +
    "                <h5 class=\"route-box-title\">Pending Routes</h5>\r" +
    "\n" +
    "                <div class=\"assigned-routes\" ui-tree=\"pendingListDndOptions\" data-max-depth=\"1\" data-drag-delay=\"150\">\r" +
    "\n" +
    "                    Sort by:\r" +
  ...
  $templateCache.put('templates/estimate-route/assigned-requests-table.html',
    ...
    "            <td><span>{{:: referral.estimator_full_name}}</span></td>\n" +
  ...
  $templateCache.put('templates/estimate/add.html',
    ...
    "                            is-open=\"openDatetxnPicker\" uib-datepicker-popup\n" +
    ...
    "                            uib-datepicker-popup ng-init=\"openExpDatePicker = false\"\n" +
    ...
    "                        uib-datepicker-popup ng-init=\"openDateSignaturePicker = false\"\n" +
  ...
  $templateCache.put('templates/job-request/add.html',
    ...
    "                            name=\"date_service\"\n" +
    "                            uib-datepicker-popup ng-init=\"openDateServicePicker = false\"\n" +
